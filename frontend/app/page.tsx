    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="flex items-center gap-3">
          <a href="/test-results">
            <Button
              variant="ghost"
              size="lg"
              className="text-gray-600 hover:text-blue-600 hover:bg-blue-50 px-6 py-2"
            >
              Test Results
            </Button>
          </a>
          <a href="/dashboard">
            <Button
              variant="outline"
              size="lg"
              className="border-blue-200 text-blue-600 hover:bg-blue-50 px-6 py-2"
            >
              Get Started
            </Button>
          </a>
      ...
      <section className="px-6 py-20 max-w-6xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
          Transform your Amazon listings with AI agents that analyze
          competitors, score keywords, and generate optimized SEO strategies
          using advanced Helium 10 data intelligence.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a href="/dashboard">
            <Button
              size="lg"
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-lg h-12"
            >
              Start Research
            </Button>
          </a>
          <a href="/test-results">
            <Button
              variant="outline"
              size="lg"
              className="border-blue-600 text-blue-600 hover:bg-blue-50 px-8 py-4 text-lg h-12"
            >
              View Test Results
            </Button>
          </a>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our intelligent agent system orchestrates complex research
              workflows to deliver actionable insights for your Amazon business.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="p-6 border-blue-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Automatically fetches competitor data from Helium 10 APIs
              </p>
            </Card>
            ...
            <Card className="p-6 border-blue-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Categorizes and scores keywords using advanced algorithms
              </p>
            </Card>
            ...
            <Card className="p-6 border-blue-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Prioritizes keywords by relevancy, volume, and competition
              </p>
            </Card>
            ...
            <Card className="p-6 border-blue-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Generates optimized titles and bullet points for listings
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Enter your Amazon product URL or ASIN along with marketplace
                selection
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our agents analyze competitors, extract keywords, and score
                relevancy automatically
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Receive categorized keywords, SEO comparison, and optimized
                listing suggestions
              </p>
            </div>
          </div>
      ...
      <section className="px-6 py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Get detailed insights and actionable recommendations for every
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Join sellers who are already using AI-powered keyword research to
            improve their Amazon performance and increase sales.
          </p>
      ...
      <footer className="px-6 py-12 border-t border-gray-100">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 pt-8 border-t border-gray-100 text-center text-sm text-gray-500">
            © 2024 KeywordAI. All rights reserved. Powered by AI agents and
            Helium 10 data.
          </div>
        </div>
      </footer>
